...
},{}],"models/registrarse.js":[function(require,module,exports) {
"use strict";
...
},{"regenerator-runtime/runtime":"../../node_modules/regenerator-runtime/runtime.js","axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"views/registrarseVista.js":[function(require,module,exports) {
"use strict";
...
var mostrarSweetAlert = function mostrarSweetAlert(respuesta) {
  if (respuesta.data.status === 'Exito') {
    ...
    configurarSweetAlert('success', 'Felicidades!', 'Te has registrado con exito').then(function (respuesta) {
      if (respuesta.value) {
        location.assign('/');
      }
    });
    ...
    if (respuesta.data.message.includes('duplicate key error collection')) {
      configurarSweetAlert('error', 'Error!', 'Existe un usuario con este email');
      return;
    }

    if (respuesta.data.message.includes('is shorter than the minimum allowed')) {
      configurarSweetAlert('error', 'Error!', 'La contraseña debe de tener al menos 8 caracteres');
      return;
    }
    ...
    if (respuesta.data.message.includes('Ingresa un correo electrónico valido')) {
      configurarSweetAlert('error', 'Error!', 'Ingresa un correo electrónico válido');
      return;
    }
  }
};
...
},{"../base":"base.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
},{"./base":"base.js","./models/registrarse":"models/registrarse.js","./views/registrarseVista":"views/registrarseVista.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
